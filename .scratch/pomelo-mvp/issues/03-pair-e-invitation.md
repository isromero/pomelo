...
- [x] Mientras espera, el creador puede recorrer una demo claramente identificada de Moment, privacidad, Reveal y Memory sin crear datos reales, y volver a la Invitation.
